                ...
                <tr>
                  ...
                  <th className='bg-primary'>
                    <div className='flex-r-c'>
                      <Link href={route('instructor.index', {name,email,id,address,username})} className='btn btn-secondary btn-sm  mt-4 mr-4'>
                        Search
                      </Link>
                    </div>
                  </th>
                ...
                <tr key={index} className='cursor-pointer hover'>
                  <td>
                    <div className="flex items-center space-x-3 ml-3 my-3">
                        ...
                        <div>
                            <div className="font-bold">{row.users.name}</div>
